...
void bind_atsc3_config(py::module& m)
{
    ...
    py::enum_<::gr::atsc3::atsc3_lls_service_count_t>(m,"atsc3_lls_service_count_t")
        .value("LLS_ONE_SERVICE", ::gr::atsc3::atsc3_lls_service_count_t::LLS_ONE_SERVICE) // 0
        .value("LLS_TWO_SERVICE", ::gr::atsc3::atsc3_lls_service_count_t::LLS_TWO_SERVICE) // 1
        .export_values()
    ;

    py::implicitly_convertible<int, ::gr::atsc3::atsc3_lls_service_count_t>();

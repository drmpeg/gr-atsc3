...
typedef struct {
  ...
  int plp_fec_type_1st;
  int plp_mod_1st;
  int plp_cod_1st;
  int plp_fec_type_2nd;
  int plp_mod_2nd;
  int plp_cod_2nd;
  int plp_TI_mode;

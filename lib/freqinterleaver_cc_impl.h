...
namespace gr {
  namespace atsc3 {
    ...
    class freqinterleaver_cc_impl : public freqinterleaver_cc
    {
     ...
     public:
      freqinterleaver_cc_impl(atsc3_fftsize_t fftsize, int numpayloadsyms, int numpreamblesyms, atsc3_guardinterval_t guardinterval, atsc3_pilotpattern_t pilotpattern, atsc3_first_sbs_t firstsbs, atsc3_frequency_interleaver_t mode, atsc3_reduced_carriers_t cred, atsc3_reduced_carriers_t pcred);

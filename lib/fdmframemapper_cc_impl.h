...
#ifndef INCLUDED_ATSC3_FDMFRAMEMAPPER_CC_IMPL_H
#define INCLUDED_ATSC3_FDMFRAMEMAPPER_CC_IMPL_H
...
namespace gr {
  namespace atsc3 {
    ...
    class fdmframemapper_cc_impl : public fdmframemapper_cc
    {
     private:
      int l1b_mode;
      int l1d_mode;
...
#endif /* INCLUDED_ATSC3_FDMFRAMEMAPPER_CC_IMPL_H */

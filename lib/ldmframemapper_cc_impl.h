...
#ifndef INCLUDED_ATSC3_LDMFRAMEMAPPER_CC_IMPL_H
#define INCLUDED_ATSC3_LDMFRAMEMAPPER_CC_IMPL_H
...
namespace gr {
  namespace atsc3 {
    ...
    class ldmframemapper_cc_impl : public ldmframemapper_cc
    {
     private:
      int l1b_mode;
      int l1d_mode;
      ...
      int fec_cells_core;
      int fec_cells_enh;
      int plp_lls_flag_core;
      int plp_lls_flag_enh;
...
#endif /* INCLUDED_ATSC3_LDMFRAMEMAPPER_CC_IMPL_H */

...
#include "subbootstrap_cc_impl.h"
...
namespace gr {
  namespace atsc3 {
    ...
    subbootstrap_cc::make(atsc3_fftsize_t fftsize1st, int numpayloadsyms1st, int numpreamblesyms, atsc3_guardinterval_t guardinterval1st, atsc3_pilotpattern_t pilotpattern1st, atsc3_fftsize_t fftsize2nd, int numpayloadsyms2nd, atsc3_guardinterval_t guardinterval2nd, atsc3_pilotpattern_t pilotpattern2nd, atsc3_min_time_to_next_t frameinterval, atsc3_l1_fec_mode_t l1bmode, atsc3_bootstrap_mode_t outputmode, atsc3_showlevels_t showlevels, float vclip)
    {
      return gnuradio::make_block_sptr<subbootstrap_cc_impl>(
        fftsize1st, numpayloadsyms1st, numpreamblesyms, guardinterval1st, pilotpattern1st, fftsize2nd, numpayloadsyms2nd, guardinterval2nd, pilotpattern2nd, frameinterval, l1bmode, outputmode, showlevels, vclip);
    }
     ...
     */
    subbootstrap_cc_impl::subbootstrap_cc_impl(atsc3_fftsize_t fftsize1st, int numpayloadsyms1st, int numpreamblesyms, atsc3_guardinterval_t guardinterval1st, atsc3_pilotpattern_t pilotpattern1st, atsc3_fftsize_t fftsize2nd, int numpayloadsyms2nd, atsc3_guardinterval_t guardinterval2nd, atsc3_pilotpattern_t pilotpattern2nd, atsc3_min_time_to_next_t frameinterval, atsc3_l1_fec_mode_t l1bmode, atsc3_bootstrap_mode_t outputmode, atsc3_showlevels_t showlevels, float vclip)
        ...
        bootstrap_fft(BOOTSTRAP_FFT_SIZE, 1)
    {
      ...
      switch (guardinterval1st) {
        case GI_1_192:
          ...
          break;
        case GI_2_384:
          guard_interval[0] = 384;
          break;
        case GI_3_512:
          guard_interval[0] = 512;
          break;
        case GI_4_768:
          guard_interval[0] = 768;
          break;
        case GI_5_1024:
          guard_interval[0] = 1024;
          break;
        case GI_6_1536:
          guard_interval[0] = 1536;
          break;
        case GI_7_2048:
          guard_interval[0] = 2048;
          break;
        case GI_8_2432:
          guard_interval[0] = 2432;
          break;
        case GI_9_3072:
          guard_interval[0] = 3072;
          break;
        case GI_10_3648:
          guard_interval[0] = 3648;
          break;
        case GI_11_4096:
          guard_interval[0] = 4096;
          break;
        case GI_12_4864:
          guard_interval[0] = 4864;
          break;
        default:
          guard_interval[0] = 192;
          break;
      ...
      switch (guardinterval2nd) {
        case GI_1_192:
          ...
          break;
        case GI_2_384:
          guard_interval[1] = 384;
          break;
        case GI_3_512:
          guard_interval[1] = 512;
          break;
        case GI_4_768:
          guard_interval[1] = 768;
          break;
        case GI_5_1024:
          guard_interval[1] = 1024;
          break;
        case GI_6_1536:
          guard_interval[1] = 1536;
          break;
        case GI_7_2048:
          guard_interval[1] = 2048;
          break;
        case GI_8_2432:
          guard_interval[1] = 2432;
          break;
        case GI_9_3072:
          guard_interval[1] = 3072;
          break;
        case GI_10_3648:
          guard_interval[1] = 3648;
          break;
        case GI_11_4096:
          guard_interval[1] = 4096;
          break;
        case GI_12_4864:
          guard_interval[1] = 4864;
          break;
        default:
          guard_interval[1] = 192;
          break;
     ...
     */
    subbootstrap_cc_impl::~subbootstrap_cc_impl()
    {
    }

    void
    subbootstrap_cc_impl::forecast (int noutput_items, gr_vector_int &ninput_items_required)
    {
    ...
    void
    subbootstrap_cc_impl::init_pseudo_noise_sequence(void)
    {
      int sr = 0x19d;
    ...
    void
    subbootstrap_cc_impl::init_zadoff_chu_sequence(void)
    {
      int q = 137;
    ...
    int
    subbootstrap_cc_impl::gray_code_cyclic_shift(int signal_bits)
    {
      int m[11];
      int sum, weight;
    ...
    unsigned char
    subbootstrap_cc_impl::reversebits(unsigned char b)
    {
      b = (b & 0xF0) >> 4 | (b & 0x0F) << 4;
      b = (b & 0xCC) >> 2 | (b & 0x33) << 2;
      b = (b & 0xAA) >> 1 | (b & 0x55) << 1;
    ...
    std::vector<float>
    subbootstrap_cc_impl::design_resampler_filter_float(const unsigned interpolation, const unsigned decimation, const float fractional_bw)
    {
    ...
    subbootstrap_cc_impl::design_resampler_filter(const unsigned interpolation, const unsigned decimation, const float fractional_bw)
    {
    ...
    void
    subbootstrap_cc_impl::set_taps(const std::vector<gr_complex>& taps)
    {
      d_new_taps = taps;
    ...
    void
    subbootstrap_cc_impl::install_taps(const std::vector<gr_complex>& taps)
    {
    ...
    int
    subbootstrap_cc_impl::general_work (int noutput_items,
                       ...
                       gr_vector_void_star &output_items)
    {
      ...
      for (int i = 0; i < noutput_items; i += insertion_items) {
        ...
        memcpy(out, in0, sizeof(gr_complex) * frame_items[0]);
        out += frame_items[0];
        memcpy(out, in1, sizeof(gr_complex) * frame_items[1]);
        out += frame_items[1];

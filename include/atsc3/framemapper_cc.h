  ...
  namespace atsc3 {
    ...
    class ATSC3_API framemapper_cc : virtual public gr::block
    {
     public:
       ...
       */
      static sptr make(atsc3_framesize_t framesize, atsc3_code_rate_t rate, atsc3_constellation_t constellation, atsc3_fftsize_t fftsize, int numpayloadsyms, atsc3_guardinterval_t guardinterval, atsc3_l1_fec_mode_t l1bmode, atsc3_l1_fec_mode_t l1dmode);
    };

  ...
  namespace atsc3 {
    ...
    class ATSC3_API paprtr_cc : virtual public gr::sync_block
    {
     public:
       ...
       */
      static sptr make(atsc3_fftsize_t fftsize, int numpayloadsyms, int numpreamblesyms, atsc3_pilotpattern_t pilotpattern, atsc3_first_sbs_t firstsbs, atsc3_papr_t paprmode, atsc3_reduced_carriers_t cred, float vclip, int iterations, unsigned int vlength);
    };
